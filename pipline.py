...
X=np.load('/home/u3749/code/32_rescale_X.npy')
Y=np.load('/home/u3749/code/32_rescale_Y.npy')
X_test=np.load('/home/u3749/code/32_rescale_X_test.npy')
Y_test=np.load('/home/u3749/code/32_rescale_Y_test.npy')
...
pv=model.predict(gray_imgs_mat_test)


res=np.concatenate((all_cervix_images_test,pvx),axis=1)

with open('/home/u3749/code/output.csv','wb') as f:
