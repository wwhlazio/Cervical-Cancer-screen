...
network = input_data(shape=[None, 16, 16, 3],
...
model.fit(X, Y, n_epoch=30, shuffle=True, validation_set=(X_test, Y_test),show_metric=True, batch_size=96, run_id='cvix_cnn')

model.fit(XA, YA, n_epoch=100, shuffle=True, validation_set=0.3,show_metric=True, batch_size=96, run_id='cvix_cnn')
...
import csv
with open('/home/u3749/code/output_64_2.csv','w') as f:
